...
public class CadastroFuncionalidade extends BaseTeste {
	...
	this.utils.preencheCampoTexto(this.cadastroPage.getAddress2(), "Bloco 2 - 2° Andar, Barueri - SP");
	this.utils.preencheCampoTexto(this.cadastroPage.getCity(), "Alabama");
	this.utils.selectByValue(this.cadastroPage.getState(), "11");
	this.utils.preencheCampoTexto(this.cadastroPage.getinformation(),"Treinando Automa��o na Yaman:");
